...
client.on("message", (msg) => {
    ...
    if (cmd.includes("qin") || cmd.includes("qd") || cmd.includes("flushed") || cmd.includes("q d") || cmd.includes("sex") || cmd.includes("deng") || cmd.includes("😳") || msg.author.id === "378976596255571969" ) {
        msg.react("😳")
    }
